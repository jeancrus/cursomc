...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat1, cat3, cat4, cat5, cat6, cat7)); // salva varios
																									// objetos numa
																									// lista
		...
		Cidade c3 = new Cidade(null, "Ponta Grossa", est2);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jean.carlos@pucpr.edu.br", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		// TipoCliente.PESSOAFISICA pois o mesmo é um enum
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "saintj34n@gmail.com", "65348782408",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("98323239", "342424425"));
		

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "1212242342", cli2, c2);
