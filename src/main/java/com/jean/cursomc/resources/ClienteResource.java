...
public class ClienteResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClienteNewDTO objDto) { //request body pois necessário para que o json seja reconhecido automaticamente para o java
